...
<div align="center">
  ...
  <h1 align="center">OpenHands: コードを書く量を減らし、より多くを作る</h1>
</div>
...
スクリプト可能な[ヘッドレスモード](https://docs.all-hands.dev/modules/usage/how-to/headless-mode)でOpenHandsを実行したり、
...
- [Github Issuesを読んだり投稿したりする](https://github.com/All-Hands-AI/OpenHands/issues) - 私たちが取り組んでいる課題をチェックしたり、あなた自身のアイデアを追加したりしてください。
...
OpenHandsは多くの貢献者によって構築されており、すべての貢献に大変感謝しています！また、他のオープンソースプロジェクトの上に構築されており、彼らの仕事に深く感謝しています。
